...
import com.connectionService.filter.CustomAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers(HttpMethod.GET,"/api/v1/connService/testAuth").hasAnyAuthority("ROLE_ADMIN","ROLE_USER");
